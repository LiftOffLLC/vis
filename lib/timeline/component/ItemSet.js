    ...
    if (this.touchParams.itemProps) {
        ...
        this.touchParams.itemProps.forEach(
            function(props) {
                ...
                if (event.additionalEvent === "pandown" && event.center.y > me.body.domProps.scrollTop && verticlCursrPos + 250 >= windowHeight) {
                ...
                if (updateTimeAllowed) {
                    if (props.dragLeft) {
                        ...
                        if (itemData.start != undefined) {
                            ...
                            var xValue = event.center.x - util.getAbsoluteLeft(centerContainer) + centerContainer.offsetLeft;
                            ...
                            itemData.start = new Date(me.body.util.toTime(xValue).getTime() - (2.5*60*60*1000));
